window.RAW_EXAMS_PENDING.push({
  ...
  raw: `All of the following are true about fMRI EXCEPT: >> C)
...
One of the patient preparations for MRA is: >> B)
* NPO for 2 days
* NPO for 4-6 hours
* NPO for 24 hours
...
To achieve a T2-weighted image in the spin echo pulse sequence: >> C)
...
To increase image contrast in a GRE image: >> E)
* PD W, use small FA, long TR and TE
* T2 W, use long TR and TE
* T1 W, use long TE
* T2 W, use large FA
* T1 W, use large flip angle
-- In GRE, a large flip angle approaching 90° maximises T1 weighting. Option A is wrong because PD requires short TE not long. Option B is wrong because GRE cannot produce true T2, only T2*. Option C is wrong because long TE gives T2* not T1. Option D is wrong because large FA gives T1 weighting, not T2.

For a sagittal brain MRI slice, the phase encoding gradient should be set in the: >> D)
...
* All of the above
* None of the above
-- All three are correct. The 180° pulse is applied at TE/2 after the 90° pulse by definition, the interval between successive 180° pulses equals the echo spacing which equals TE, and the echo is formed at TE after the 90° pulse, also by definition.
...
The highest-SNR sequence among the following is: >> C)
* Turbo Spin Echo (TSE)
...
All of the following are true regarding suppression of fatty tissue EXCEPT: >> D)
...
All are correct regarding brain MRI EXCEPT: >> D)
* Head coil is used
...
All are correct regarding RF safety EXCEPT: >> D)
...
* None of the above
-- In STIR the fat signal is nulled and appears grey-dark. CSF has long T2 and appears bright. The spinal cord, with shorter T2, appears grey-dark. Option B is wrong because fat cannot be bright in a STIR sequence; the defining feature being tested is the signal behaviour of the STIR sequence itself.

All are correct regarding proton density contrast applications EXCEPT: >> E)
* Edema
* Inflammation
* Cyst
* Infection
...
window.RAW_EXAMS_PENDING.push({
  ...
  raw: `One of the following improves image spatial resolution: >> D)
* Large pixel size
* Large pitch
...
All of the following statements are true regarding the Test Bolus procedure EXCEPT: >> E)
* Obtain scout views
...
Thorough patient preparation and education prior to a CT scan will: >> E)
...
Which factor(s) determine the automatic power injector flow rate during a CT exam? >> E)
...
Stair-step artefact can be best alleviated by: >> D)
* Narrow collimation
* Pitch < 1
* Wide collimation
* a + b
...
The three phases of IV contrast enhancement are: >> D)
...
Compared with traditional angiography, CTA has all of the following advantages EXCEPT: >> D)
* Widely available
* Time saving
* Cheap
* More invasive
...
Head CT is usually scanned using two slice-thickness settings in order to: >> C)
...
Which laboratory test(s) should be performed prior to CT exams that require IV contrast media injection? >> D)
* Liver enzymes
...
Tissue death (necrosis) due to inadequate blood supply, which may be caused by artery blockage, rupture, mechanical compression, or vasoconstriction, is called: >> C)
* Ischemic stroke
...
A sensation of loss of balance is called: >> D)
* Dural Sinuses
* Intracranial bleeding
* Infarction
* Vertigo
...
All of the following statements are true regarding the Test Bolus procedure EXCEPT: >> C)
* Obtain scout views
* Inject 10-20 ml of contrast
...
Reactions which require treatment but are not immediately life-threatening are called: >> B)
* Mild Reactions
* Moderate Reactions
* Severe Reactions
* None of the above
...
Which of the following is NOT typically recommended during a CT soft tissue neck study? >> B)
* Removal of dentures
...
Which of the following would reduce the viscosity of an IV contrast agent? >> B)
* Stirring
* Warming
* Shaking
* Cooling
...
All are correct regarding CT scans of the abdomen EXCEPT: >> B)
